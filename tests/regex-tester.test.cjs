...
assert.match(page, /const regexTemplates = \[/);
assert.match(page, /id: 'phone'/);
assert.match(page, /name: '手机号脱敏'/);
assert.match(page, /id: 'url'/);
assert.match(page, /name: 'URL 地址'/);
assert.match(page, /id: 'jdbc'/);
assert.match(page, /name: 'JDBC 连接串'/);
assert.match(page, /id: 'ipv4'/);
assert.match(page, /name: 'IPv4 地址'/);
assert.match(page, /id: 'email'/);
assert.match(page, /name: '邮箱地址'/);
assert.match(page, /id: 'log-time'/);
assert.match(page, /name: '日志时间'/);
assert.match(page, /id: 'stack'/);
assert.match(page, /name: '异常堆栈行'/);
