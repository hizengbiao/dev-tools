...
assert.match(page, /<div class="changelog-date">2026年7月23日<\/div>[\s\S]*?<div class="changelog-version">V1\.17<\/div>/);
assert.match(page, /<div class="changelog-date">2026年7月23日<\/div>[\s\S]*?<div class="changelog-version">V1\.16<\/div>/);
assert.match(page, /<div class="changelog-date">2026年7月17日<\/div>[\s\S]*?<div class="changelog-version">V1\.15<\/div>/);
