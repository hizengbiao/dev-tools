...
assert.match(page, /<div class="changelog-date">2026年7月23日<\/div>[\s\S]*?<div class="changelog-version">V1\.08<\/div>/);
assert.match(page, /<div class="changelog-date">2026年7月23日<\/div>[\s\S]*?<div class="changelog-version">V1\.07<\/div>/);
assert.match(page, /<div class="changelog-date">2026年7月14日<\/div>[\s\S]*?<div class="changelog-version">V1\.06<\/div>[\s\S]*?<div class="changelog-date">2026年7月5日<\/div>[\s\S]*?<div class="changelog-version">V1\.05<\/div>/);
assert.match(page, /\.editor-shell\s*\{[\s\S]*?height:\s*min\(32vh, 300px\);[\s\S]*?min-height:\s*240px;/);
