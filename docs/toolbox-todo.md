...
- 完成记录：2026-07-23 已扩展 `clipboard-utils.js` 的剪贴板读取和目标输入框粘贴能力，并接入命名转换、正则测试、文本转义、文本拆分、SQL、URL、Base64、哈希摘要和 JWT 共 9 个工具；权限失败或剪贴板为空时显示明确提示，各页面同步更新版本说明并补充公共能力和接入测试。
